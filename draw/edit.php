                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <select name="category" id="category" class="input" required>
                                ...
                                <option value="heavy meal" <?= ($product["category"] == 'heavy meal') ? 'selected' : '' ?>>Heavy Meal</option>
                                <option value="snack" <?= ($product["category"] == 'snack') ? 'selected' : '' ?>>Snack</option>
                                <option value="cold dirnk" <?= ($product["category"] == 'cold drink') ? 'selected' : '' ?>>Cold Dirnk</option>
                            </select>
                        </li>
                        <li>
